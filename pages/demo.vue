      ...
      <div class="flex-1 p-6">
        <div class="">
          ...
          <div class="flex px-2 gap-2 justify-center py-5">
            <div
              class="flex gap-x-[50px] my-1 p-4 px-56 border-primary border-2"
            >
              <p class="text-xl font-bold">PA-012_dsqfmd_qsdf_000_01</p>
              <span
                class="
                  inline-block
        ...
        <div class="flex gap-2 py-5">
          <div class="border-[1px]">
            <div class="flex items-center justify-between p-2 xl:items-start">
              ...
              <div
                class="max-w-[250px] flex items-center gap-[5px] xl:items-start"
              >
