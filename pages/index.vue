          ...
          <div class="mx-auto px-4 text-center w-full lg:w-8/12">
            <div class="-mb-40 bg-white mt-10 p-16 rounded-lg">
              ...
              >
                ...
                <g>
                  <path
                    id="uuid-d0b76542-8f08-4363-846d-0cc3b89caf22-258"
                  ...
                  <g>
                    <path
                      id="uuid-35da8825-ceb1-46f8-a8e3-884fcc945dd4-259"
                ...
                <g>
                  <path
                    id="uuid-ba1531a6-e7ab-4297-b996-1d676f43fe3f-260"
                  ...
                  <g>
                    <path
                      id="uuid-375aaccb-22f9-42b6-a352-baabb12db8d2-261"
        ...
        <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full p-4 xl:w-3/12 sm:w-6/12">
            ...
            >
              ...
              <p class="mb-4 text-sm">
                Create templates from predefined fields
              </p>
              <span
                class="
                  border-b
          ...
          <div class="w-full p-4 xl:w-3/12 sm:w-6/12">
            ...
            >
              ...
              <p class="mb-4 text-sm">
                Get your team on the same page with team templates.
              </p>
              <span
                class="
                  border-b
          ...
          <div class="w-full p-4 xl:w-3/12 sm:w-6/12">
            ...
            >
              ...
              <p class="mb-4 text-sm">Your document names get saved.</p>
              <span
                class="
                  border-b
                  font-normal
